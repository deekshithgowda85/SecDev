...
To report a security vulnerability in **SecDev**, please contact the maintainer through one of the following channels:

- 👤 Maintainer Profile: [Github](https://github.com/deekshithgowda85)
...
- SecDev Repository: https://github.com/deekshithgowda85/SecDev
