                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-gray-900 dark:text-foreground text-sm">Introducing Support for AI Models</span>
                                        ...
                                        <div className="bg-white dark:bg-background group-hover:bg-gray-100 dark:group-hover:bg-muted size-6 overflow-hidden rounded-full duration-500">
                                            <div className="flex w-12 -translate-x-1/2 duration-500 ease-in-out group-hover:translate-x-0">
                                                <span className="flex size-6">
                                                    <ArrowRight className="m-auto size-3 text-gray-900 dark:text-foreground" />
                                                </span>
                                                <span className="flex size-6">
                                                    <ArrowRight className="m-auto size-3 text-gray-900 dark:text-foreground" />
                                                </span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem] text-gray-900 dark:text-white">
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link href="/console/dashboard">
                                            <span className="text-nowrap">View Console</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
